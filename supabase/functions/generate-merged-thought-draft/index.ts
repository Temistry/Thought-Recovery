...
function buildPrompt(flowTitle: string, notes: Required<SourceNote>[]) {
  ...
  return [
    ...
    '',
    '규칙:',
    '1. body 첫 문장은 단정적 1인칭 결론이 아니라 “이 원문들에서 반복해서 보이는 것은...” 같은 리포트 문장으로 시작한다.',
    '2. “나는 이 문제에 대해 이렇게 생각하게 됐다”처럼 사용자의 결론을 확정하지 않는다.',
    '3. 원문을 길게 직접 인용하지 않는다. 따옴표 안에 원문 문장을 20자 넘게 넣지 않는다.',
    '4. 각 원본 메모를 모두 소진하려 하지 말고, 같은 판단축에 기여하는 메모만 사용한다.',
    '5. 서로 중복되는 내용은 합치고, 충돌하는 내용은 생각 변화/미해결 쟁점으로 표현한다.',
    '6. 없는 사실을 새로 만들지 않는다.',
    '7. 문체는 담백하고 자연스럽게 쓴다.',
    '8. 원본 메모 5개 기준 body는 900~1,600자 정도로 작성한다. 원문이 짧거나 공통축이 약하면 더 짧아도 된다.',
    '',
    '출력은 JSON만 사용한다:',
    '{',
    '  "title": "생각 정리 리포트 제목",',
